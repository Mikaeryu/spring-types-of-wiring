...
public class MainTest {
    ...
    public void mainTest() {
        String text = "На море на океане есть остров, на том острове дуб стоит, под дубом сундук зарыт, в сундуке — " +
                "заяц, в зайце — утка, в утке — яйцо, в яйце — иголка, смерть Кощея на игле :( ...СМ3РТЬ";
